...
## Changelog
- June 22, 2025: **STANDARD WALLETCONNECT MODAL INTEGRATED**: Replaced custom wallet modal with official WalletConnect Web3Modal for industry-standard wallet connection experience. Features automatic wallet detection, QR code support for mobile wallets, 150+ supported wallets, improved security, and standardized UI/UX. Users now get the familiar WalletConnect interface they expect, with better mobile wallet support and automatic wallet installation detection. Configured with Hedera-compatible themes and proper wallet prioritization.
