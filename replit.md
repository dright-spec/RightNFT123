...
- June 22, 2025: **WALLET CONNECTION FIXED**: Replaced problematic WalletConnect Web3Modal with simplified wagmi configuration using only MetaMask and browser wallets. Eliminated authentication errors and external API dependencies. Restored correct "Submit for Verification" workflow instead of "Create NFT" direct minting.
