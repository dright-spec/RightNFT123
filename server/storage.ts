...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    // Create sample rights focused on music and video content
    const sampleRights: (InsertRight & { creatorId: number; ownerId: number })[] = [
      ...
      {
        title: "Music Video Sync Rights",
        type: "license",
        description: "Commercial synchronization rights for 'Electric Nights' music video. License for use in commercials, films, and media content.",
        symbol: "📜",
        paysDividends: true,
      ...
      {
        title: "Podcast Intro Music Rights",
        type: "license",
        description: "Exclusive rights to use 'Dawn Break' as intro music for 'Morning Motivation' podcast with 1.2M monthly downloads.",
        symbol: "📜",
        paysDividends: false,
        price: "2.1",
        currency: "ETH",
