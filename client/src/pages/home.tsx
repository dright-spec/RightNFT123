      ...
      <section className="relative overflow-hidden hero-gradient py-20 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-16 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-2xl p-8 max-w-5xl mx-auto">
              <div className="text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/50 rounded-full text-green-700 dark:text-green-300 text-sm font-medium mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4">
                    ...
                    <div className="text-sm text-green-700 dark:text-green-300 font-medium">Average Monthly Earnings</div>
                    <div className="text-xs text-green-600 dark:text-green-400">Per tokenized song</div>
                  </div>
                  <div className="text-center p-4">
                    <div className="text-3xl font-bold text-emerald-600 mb-2">72hrs</div>
                    <div className="text-sm text-emerald-700 dark:text-emerald-300 font-medium">Average Time to First Sale</div>
                    <div className="text-xs text-emerald-600 dark:text-emerald-400">From listing to purchase</div>
                  </div>
                  <div className="text-center p-4">
                    <div className="text-3xl font-bold text-teal-600 mb-2">156%</div>
                    <div className="text-sm text-teal-700 dark:text-teal-300 font-medium">Average Price Increase</div>
                    <div className="text-xs text-teal-600 dark:text-teal-400">In first 6 months</div>
                  </div>
                </div>
              </div>
            </div>
